...
import { baseColumns,baseValidationSchema, cancelledCustomersState, baseDispatchers } from './CustomerItemsHelper';
...
export default function CancelledCustomers() {
  ...
  const items = useSelector(cancelledCustomersState);
